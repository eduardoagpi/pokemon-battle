...
export function NickNameSelector({ nickname, onConfirm }: Props) {
    const { nickname: currentNickname, setNickname, handleSubmit } = useNickNameSelector(onConfirm, nickname);
